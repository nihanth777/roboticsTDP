function [players,flag_gamestate,ball_posess_flag] = initialparams(players)
...
if flag_gamestart == gamestate.start
   [x_attacker_home,y_attacker_home,x_attacker_away,y_attacker_away,ball_posess_flag] = cointoss();
