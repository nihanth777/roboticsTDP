...
%%%plotting here
viscircles([(xlimit_outer/2)+ 50 (ylimit_outer/2)+50],15,'Color','w'); % can be for index 3 and opp team
viscircles([(xlimit_outer/2)- 50 (ylimit_outer/2)-50],15,'Color','g'); % can be for index 
viscircles([(xlimit_outer/2)- 50 (ylimit_outer/2)+50],15,'Color','r'); % can be for index 
viscircles([(xlimit_outer/2)+ 50 (ylimit_outer/2) - 50],15,'Color','r'); % can be for index 

viscircles([272 128],8,'Color','r'); % can be for index 
viscircles([272 159],8,'Color','r'); % can be for index 
viscircles([272 159-60],8,'Color','r'); % can be for index 

viscircles([80 128],8,'Color','r'); % can be for index 
viscircles([80 128-30],8,'Color','r'); % can be for index
viscircles([80 128+30],8,'Color','r'); % can be for index

%rectangle('Position', [0 0 xlimit_outer ylimit_outer],'LineWidth', 4, 'FaceColor','#567d46');
%rectangle('Position', [190 80 250 205], 'LineWidth', 2,'EdgeColor','w');
